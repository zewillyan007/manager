...
type NetworkStatusIRepository interface {
	port_shared.IRepositoryCRUD
	//GetAll(conditions ...interface{}) []*entity.NetworkStatus
	//Remove(*entity.NetworkStatus) error
	//Get(int64) (*entity.NetworkStatus, error)
	//Save(*entity.NetworkStatus) (*entity.NetworkStatus, error)
	...
	//WithTransaction(transaction port_shared.ITransaction) NetworkStatusIRepository
